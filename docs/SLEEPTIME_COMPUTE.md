...
## From VoltMem to Letta's Sleeptime Compute — and Why My Shower Thoughts Are Prior Art
...
The Letta blog post on [sleeptime compute](https://www.letta.com/blog) was in my browser history the next morning.
...
No actions. No output. Just filing.
...
These are the gaps VoltMem has. Sleeptime compute is one architecture for filling them.
...
*[VoltMem on GitHub](https://github.com/Rouche01/voltmem) · [Original VoltMem writeup](https://dev.to/rouche01/i-built-a-memory-layer-for-llm-agents-that-knows-which-facts-go-stale-1mg5) · Built by [Richard Emate](https://github.com/Rouche01)*
